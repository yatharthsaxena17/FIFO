...
HD_PWD='D:/VHDL_files/FIFO/FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module_fifo_regs_with_flags.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module_fifo_regs_with_flags.tcl
