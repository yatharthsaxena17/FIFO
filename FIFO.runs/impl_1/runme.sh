...
HD_PWD='D:/VHDL_files/FIFO/FIFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log module_fifo_regs_with_flags.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source module_fifo_regs_with_flags.tcl -notrace
